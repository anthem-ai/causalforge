...
htmlhelp_basename = "CausalForgedoc"
...
latex_documents = [
    (master_doc, "CausalForge.tex", "CausalForge Documentation",
     "Gino Tesei, Jey Kottalam", "manual"),
]
...
man_pages = [
    (master_doc, "causalforge", "CausalForge Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "CausalForge", "CausalForge Documentation",
     author, "CausalForge", "One line description of project.",
     "Miscellaneous"),
]
